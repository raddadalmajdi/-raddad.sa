import{A as e,M as t,O as n,T as r,a as i,c as a,i as o,k as s,l as c,n as l,o as u,r as d,s as f,t as p,u as m}from"./chunks/ui-CQgUgTrp.js";import{n as h,r as g}from"./chunks/ideas-BVpYOvYP.js";import{a as _,i as v,n as y}from"./chunks/tickets-CC1cwFlM.js";var b=t((()=>{r(),c(),g(),v(),o();function t(e,t,n){if(!t.length){e.innerHTML=`<p class="muted">لا توجد تذاكر.</p>`;return}e.innerHTML=t.map(e=>{let t=n?`<select data-ticket-status data-id="${l(e.id)}" aria-label="حالة التذكرة">
